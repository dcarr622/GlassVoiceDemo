...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        Intent startSpeech = SpeechActivationService.makeStartServiceIntent(this, getResources().getString(root.gast.R.string.speech_activation_speak));
        startService(startSpeech);
    ...
    private View buildView() {
        ...
        card.setText(R.string.listening);
        return card.getView();
    }
